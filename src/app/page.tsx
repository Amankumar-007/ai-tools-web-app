    ...
    <div className="min-h-screen">
      ...
      <nav className="flex items-center justify-between px-6 py-4">
        <div className="flex items-center space-x-4">
          <span className="text-2xl font-bold text-purple-600">QuickAI</span>
          <span className="text-sm bg-orange-500 text-white px-2 py-1 rounded">Beta</span>
          <Link href="/ai-tools" className="text-gray-600 hover:text-black">AI Tools</Link>
          <Link href="/categories" className="text-gray-600 hover:text-black">Categories</Link>
          <Link href="/trending" className="text-gray-600 hover:text-black">Trending</Link>
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-gray-400">😄</span>
          <span className="text-gray-400">✨</span>
          <span className="text-gray-400"><ThemeToggleButton variant="gif" url="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExMWI1ZmNvMGZyemhpN3VsdWp4azYzcWUxcXIzNGF0enp0eW1ybjF0ZyZlcD12MV9zdGlja2Vyc19zZWFyY2gmY3Q9cw/Fa6uUw8jgJHFVS6x1t/giphy.gif" />
      ...
      <main className="flex flex-col items-center justify-center text-center mt-20">
        ...
        >
          <a href="https://www.producthunt.com" target="_blank" rel="noopener noreferrer">
            <span className="bg-red-500 text-white text-sm px-2 py-1 rounded">🌟 Find us on Product Hunt</span>
          </a>
        </motion.div>
        <motion.h1
          className="text-6xl font-bold mt-6 paddding-4"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.2, duration: 0.8 }}
        >
         <FlipLink href="https://x.com/guri_who">Discover-the-Best</FlipLink>
          
         <FlipLink href="https://x.com/guri_who">AI-Tools</FlipLink>
        </motion.h1>
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <WrapButton className="mt-10" href="/ai-tools">
          ...
          <div className="mt-4 flex flex-col items-center">
            ...
            <p className="text-gray-600 mt-2">Curated collection of the most powerful AI tools for every need</p>
          </div>
        </motion.div>
        <motion.div
