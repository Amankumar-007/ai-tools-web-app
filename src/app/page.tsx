...
export default function Home() {
  ...
  <div className="flex items-center space-x-4">
    ...
    <Link href="/ai-tools" onClick={(e) => handleProtectedLink(e, "/ai-tools")} className="text-gray-600 hover:text-black dark:hover:text-white">
      AI Tools
    </Link>
    <a href="#categories" className="text-gray-600 hover:text-black dark:hover:text-white">
      Categories
    </a>
    <a href="#trending" className="text-gray-600 hover:text-black dark:hover:text-white">
      Trending
    </a>
    <Link href="/resources" onClick={(e) => handleProtectedLink(e, "/resources")} className="text-gray-600 hover:text-black dark:hover:text-white">
      Resources
    </Link>
    {/* Add Pricing Link */}
    <Link href="/pricing" className="text-gray-600 hover:text-black dark:hover:text-white">
      Pricing
    </Link>
  </div>
  <div className="flex items-center space-x-2">
    {/* ... existing search and other elements ... */}
    ...
    {user ? (
      <div className="flex items-center space-x-2">
        ...
        <button onClick={handleSignOut} className="text-gray-600 hover:text-black dark:hover:text-white">
          Logout
        </button>
      </div>
    ) : (
      <>
        ...
        <Link href="/register" className="text-gray-600 hover:text-black dark:hover:text-white">
          Register
        </Link>
      </>
    )}
