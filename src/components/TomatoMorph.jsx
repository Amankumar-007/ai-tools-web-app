...
export default function NeuralCropSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="flex flex-col md:flex-row items-center w-full min-h-screen px-12 md:px-32 py-10 overflow-hidden duration-700"
    >
      <div className="w-full md:w-1/2 space-y-8 z-10">
        <div className="space-y-4">
          ...
          <h2 className="text-6xl md:text-8xl font-black leading-tight tracking-tighter text-zinc-900 dark:text-white">
            Neural <br />
            <span className="font-serif italic font-light text-red-600 dark:text-red-500">Crop Engine</span>
          </h2>
        </div>

        <p className="text-xl md:text-2xl font-light max-w-lg border-l-2 border-red-500/30 pl-8 text-zinc-600 dark:text-zinc-400 leading-relaxed">
        ...
        <button className="group relative px-8 py-4 bg-transparent border border-zinc-200 dark:border-zinc-800 hover:border-red-500 transition-all duration-500 overflow-hidden">
          <div className="absolute inset-0 bg-red-500 translate-y-full group-hover:translate-y-0 transition-transform duration-500" />
          <span className="relative text-sm uppercase tracking-widest font-bold text-zinc-500 dark:text-zinc-400 group-hover:text-white transition-colors duration-500 flex items-center">
            Explore Engine
      ...
      <div className="w-full md:w-1/2 h-[700px] relative mt-12 md:mt-0">
